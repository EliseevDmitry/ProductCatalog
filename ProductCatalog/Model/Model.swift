...
//для реализации пагинации запрашиваем общее количество товара - total, количество пропущенных объектов - skip, количество объектов, которые мы запрашиваем - limit (по условию задачи 20 товаров/стр.)
